...
@php($soustitre ='Ajouter un poste')
                        ...
                        <div class="multisteps-form mt-5 mb-5">
                            <div class="row">
                                <div class="col-12 col-lg-8 m-auto">
                                    <form class="multisteps-form__form" action="{{ route('Poste.store') }}" method="POST">
                                        @csrf @method('POST')
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="Poste_occupé" placeholder="Poste occupé" required />
                                            </div>
                                            <div class="form-group">
                                                <label for="">Superieur Hierarchique</label>
                                                <input type="text" class="form-control" name="Superieur_Hierarchique" placeholder="Superieur Hierarchique" required />
                                            </div>
                                            <div class="form-group">
                                                <label for="Vehicule_de_service">Vehicule de service</label>
                                                <input type="text" class="form-control" name="Vehicule_de_service" placeholder="Vehicule de service" required />
                                            </div>
