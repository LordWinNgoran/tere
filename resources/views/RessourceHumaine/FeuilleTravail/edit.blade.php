                        ...
                        <div class="multisteps-form mt-5 mb-5">
                            <div class="row">
                                <div class="col-12 col-lg-8 m-auto">
                                    <form class="multisteps-form__form" action="{{ route('feuille_travail.update',$data->id) }}" method="POST">
                                        @csrf @method('PUT')
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2"  name="id_employe" style="width: 100%;">
                                                    ...
                                                    <option value="{{ $employe->id }}">{{ $data->employes->Nom }} {{ $data->Prenom }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Description de l'activité</label>
                                                <input type="text" class="form-control" value="{{ $data->Description_de_activité }}" name="Description_de_activité" required />
                                            </div>
                                            <div class="form-group">
                                                <label>Date du jour:</label>
                                                <div class="input-group date" >
                                                    <input type="date" name="Date_du_jour" value="{{ $data->Date_du_jour }}" class="form-control datetimepicker-input"  />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                  ...
                                                  <input type="text" name="Tranche_horaire" value="{{ $data->Tranche_horaire }}"  class="form-control float-right" id="reservationtime">
                                                </div>
                                                <!-- /.input group -->
                                              </div>
